                      ...
                      "
                                        >
                                            <div
                                                ...
                                                "
                                            >
                                                <a href={member.socials.facebook} className="text-white hover:text-primary text-xl">
                                                    <FaFacebookF />
                                                </a>

                                                <a href={member.socials.twitter} className="text-white hover:text-primary text-xl">
                                                    <FaTwitter />
                                                </a>

                                                <a href={member.socials.linkedin} className="text-white hover:text-primary text-xl">
                                                    <FaLinkedinIn />
                                                </a>
                                            </div>
